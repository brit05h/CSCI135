...
where you add the function, bool isTwinPrime(int n);.The 
function should determine whether or not its argument is a twin prime.
*/
...
int main(){
    cout<<countPrimes(3,75)<<endl; //whether 1 is a prime,should be false
    return 0;
}
