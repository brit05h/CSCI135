...
Assignment: Lab 11D (bonus)
This program is about creating a social network with object-oriented programming.
It is an improved version of the previous program. The class Network should be changed
to allow users post messages and remember them.
*/
